...
public class Mutant : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        Waypoints[] points = patrolPoints.ToArray();
        points = FindObjectsOfType<Waypoints>();
    ...
    //IEnumerator toAlarm(float duration)
    //{
    ...
    void Update()
    {
        ...
        if(changed && navMesh.remainingDistance > 1.0f)
        {
            changed = false;
        }
